...
Cpu6502::Cpu6502(Mmu *_mmu)
{
    ...
    instructions = {        // we then initialize the list
        ...
        illegal, Instruction{ "STA", "I-X", [this](){ STA_IX(); } }, illegal, illegal, Instruction{ "STY", "ZPG", [this](){ STY_ZP(); } }, Instruction{ "STA", "ZPG", [this](){ STA_ZP(); } }, Instruction{ "STX", "ZPG", [this](){ STX_ZP(); } }, illegal, Instruction{ "DEY", "IMP", [this](){ DEY(); } }, illegal, Instruction{ "TXA", "IMP", [this](){ TXA(); } }, illegal, Instruction{ "STY", "ABS", [this](){ STY_ABS(); } }, Instruction{ "STX", "ABS", [this](){ STX_ABS(); } }, illegal,
